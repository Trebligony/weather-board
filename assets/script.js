		...
		for (var i = 1; i < response.list.length; i += 8) {
		  ...
		  cardHTML += `
			  <div class="card text-white bg-dark p-1 mr-3">
				  ...
				  <p class="card-text"> 
				  <i class="fas fa-sun fa-fw" style="color: #868B94;"></i> ${response.list[i].main.temp} f
				  </p>
				  <p class="card-text"> 
				  <i class="fas fa-tint fa-fw" style="color: #868B94;"></i> ${response.list[i].main.humidity}%
				  </p>
				  <p class="card-text"> 
				  <i class="fas fa-wind fa-fw" style="color: #868B94;"></i> ${response.list[i].wind.speed} mph
				  </p>
				  </div>
			</div>`;
